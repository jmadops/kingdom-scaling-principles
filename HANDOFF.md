...
**What:** $7 2-day virtual event. 50/50 A/B test (VSL vs. no-VSL) with embedded Stripe checkout. Lead data goes to Go High Level. Paid ads incoming.
...
- Create a **$7 one-time Product** → send me the `price_...` ID
...
**~3–4 hours** to finish wiring the frontend to the API routes, test a real $7 transaction + refund, flip DNS, confirm dashboard is pulling live data.
