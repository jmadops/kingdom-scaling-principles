...
### Why this shape
- **Stripe Embedded Checkout** (not Payment Element) gives us a branded, on-page experience with wallets (Apple Pay / Google Pay), 3DS, SCA, and receipts for free. Payment Element is more customizable but overkill for one $29 SKU.
...
| **Stripe Dashboard** | **Price ID** `price_...` | Created when you add the $29 Product. Hardcoded into the serverless function. |
...
3. Pricing = **Flat rate**, **One time**, **$29.00 USD**
